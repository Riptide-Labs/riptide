...
export CLICKHOUSE_PASSWORD=change-me-before-anyone-else-can-reach-this-host
docker compose up -d
```
...
* ClickHouse on `127.0.0.1:8123` with login default. Set `CLICKHOUSE_PASSWORD` (required); the whole stack follows it.
