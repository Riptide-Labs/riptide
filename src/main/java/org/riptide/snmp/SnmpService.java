...
public interface SnmpService {
     ...
     * still populated, and the ifXTable-only columns are simply absent from every row.
     * Those include ifName and every HC octet counter. Only v1 fails the whole collect here, because
