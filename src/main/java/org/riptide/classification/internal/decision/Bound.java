...
public abstract class Bound<T extends Comparable<T>> {
    ...
    public static class Any<T extends Comparable<T>> extends Bound<T> {
        @Override
        public Bound<T> lt(final T value) {
            return new Lt<>(value);
        }

        @Override
        public Bound<T> eq(final T value) {
            return new Eq<>(value);
        }

        @Override
        public Bound<T> gt(final T value) {
            return new Gt<>(value);
        }
        ...
        @Override
        public boolean canBeRestrictedBy(final T value) {
            return true;
        }

        @Override
        public boolean overlaps(final T begin, final T end) {
            return true;
        }
    }
    ...
    public static class In<T extends Comparable<T>> extends Bound<T> {
        ...
        public In(final T lt, final T gt) {
            this.lt = lt;
            this.gt = gt;
        }
