...
public class FlowDocument {
    ...
    @JsonProperty("netflow.application")
    ...
    @JsonProperty("netflow.direction")
    ...
    @JsonProperty("netflow.dst_addr_hostname")
    ...
    @JsonProperty("netflow.dst_locality")
    ...
    @JsonProperty("netflow.dst_mask_len")
    ...
    @JsonProperty("netflow.engine_id")
    ...
    @JsonProperty("netflow.engine_type")
    ...
    @JsonProperty("netflow.first_switched")
    ...
    @JsonProperty("netflow.flow_locality")
    ...
    @JsonProperty("netflow.flow_records")
    ...
    @JsonProperty("netflow.flow_seq_num")
    ...
    @JsonProperty("netflow.input_snmp")
    ...
    @JsonProperty("netflow.input_snmpIfName")
    ...
    @JsonProperty("netflow.ip_protocol_version")
    ...
    @JsonProperty("netflow.last_switched")
    ...
    @JsonProperty("netflow.next_hop_hostname")
    ...
    @JsonProperty("netflow.output_snmp")
    ...
    @JsonProperty("netflow.output_snmpIfName")
    ...
    @JsonProperty("netflow.sampling_algorithm")
    ...
    @JsonProperty("netflow.sampling_interval")
    ...
    @JsonProperty("netflow.src_addr_hostname")
    ...
    @JsonProperty("netflow.src_locality")
    ...
    @JsonProperty("netflow.src_mask_len")
    ...
    @JsonProperty("netflow.tcp_flags")
    ...
    @JsonProperty("netflow.delta_switched")
    private Long deltaSwitched;

    @SerializedName("netflow.tos")
    @JsonProperty("netflow.tos")
    private Integer tos;

    @SerializedName("netflow.ecn")
    @JsonProperty("netflow.ecn")
    private Integer ecn;

    @SerializedName("netflow.dscp")
    @JsonProperty("netflow.dscp")
