...
public class DefaultTemplateInitializer implements TemplateInitializer {
    ...
    public DefaultTemplateInitializer(final JestClient client, final String templateLocation, final String templateName) {
        this(client, templateLocation, templateName, new CachingTemplateLoader(new DefaultTemplateLoader()), new IndexSettings());
    }

    public DefaultTemplateInitializer(JestClient client, String templateLocation, String templateName, IndexSettings indexSettings) {
