...
Re-run `riptide onboard --create-schema`, which adds the one table and nothing else; see [Onboard a tenant](tenants/onboard-a-tenant.md#adding-the-dead-letter-table-to-an-existing-deployment).
