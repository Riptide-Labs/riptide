...
Use a [secret reference](../reference/secret-references.md) in `settings` and supply the value through `environmentFile`, as the example does with `env://CLICKHOUSE_PASSWORD`.
